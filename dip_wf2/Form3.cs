...
namespace dip_wf2
{
    public partial class Form3 : Form
    {
        ...
        {
            if (comboBox1_type.SelectedItem.ToString() == "Проверка подлинности Windows" && !String.IsNullOrWhiteSpace(nameServer) && !String.IsNullOrWhiteSpace(db__name))
            {
                OK.Enabled = true;
            }
            else if (comboBox1_type.SelectedItem.ToString() == "Проверка подлинности SQL Server" && !String.IsNullOrWhiteSpace(textBox1_nameServer.Text)
        ...
        {
            if (comboBox1_type.SelectedItem.ToString() == "Проверка подлинности Windows")
            {
